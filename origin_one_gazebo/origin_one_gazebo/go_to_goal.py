...
class GoToGoal(Node):
    ...
    def control_mecanum(self):
        ...
        # ============================================================
        # NOTA: el control mecanum (vx, vy) es parte de la TAREA.
        # Complétalo en waypoint_follower.py (modo mecanum). Este nodo
        # se usa como demo en modo skid_steer. Aquí no se implementa a
        # propósito para no dar la respuesta.
        #
        ...
        self.get_logger().warn(
            'Modo mecanum no implementado en go_to_goal (es la TAREA). '
            'Usa mode:=skid_steer, o implementa el mecanum en waypoint_follower.',
